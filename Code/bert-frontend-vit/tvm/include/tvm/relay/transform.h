...
TVM_DLL Pass FuseOpsCustom(int fuse_opt_level = -1);
TVM_DLL Pass FuseEmbedding();
TVM_DLL Pass FuseGelu();
TVM_DLL Pass FuseLinear();
TVM_DLL Pass FuseAttentionMask();
TVM_DLL Pass FuseSoftmax();
TVM_DLL Pass FuseAttention();
TVM_DLL Pass FuseMLP();
TVM_DLL Pass GenIR();
TVM_DLL Pass ReplaceAttentionMask();
TVM_DLL Pass Peephole(std::string name="swap-divide-add");
 ...
 * \return The Pass.
 */
TVM_DLL Pass SimplifyInference(bool simplify_layer_norm=false);
