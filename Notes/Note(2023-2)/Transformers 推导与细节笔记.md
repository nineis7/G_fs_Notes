...
![python顺序](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\python顺序.png)

除了```__init__```function，还有```__call__```function，该function只有在实例被调用时才被运行。而forward便是依据```__call__```function来调用的：

![call&forward](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\call&forward.png)
...
![forward调用过程](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\forward调用过程.png)
...
![Encoder structure](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\Encoder structure.png)
...
![dropout](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\dropout.png)
...
![mask](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\mask.png)
...
![attention](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\attention.png)
...
![公式1](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\公式1.png)
...
![QKV](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\QKV.png)
...
![attention原理](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\attention原理.gif)
...
![点积与多头](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\点积与多头.png)

![multi-head](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\multi-head.png)

![multi-head2](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\multi-head2.png)
...
![FFN](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\FFN.png)
...
![Embedding](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\Embedding.png)
...
![transformer_decoding_1](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\transformer_decoding_1.gif)
...
![transformer_decoding_2](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\transformer_decoding_2.gif)



## 维度笔记

![维度笔记](C:\Users\Administrator\Desktop\G_fs_Notes\Notes\Note(2023-2)\pics\维度笔记.jpg)
